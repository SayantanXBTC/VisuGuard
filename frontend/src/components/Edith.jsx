  ...
  return (
    <div className="edith">
      <AnimatePresence>
        {open && (
          <motion.section
            className="edith-panel liquid-glass"
          ...
          >
            <header className="edith-head">
              <img className="edith-avatar" src="/edith.svg" alt="" />
              <div>
                <strong>Edith</strong>
      ...
      <button className="edith-launcher liquid-glass" onClick={() => setOpen(!open)} aria-expanded={open} aria-label={open ? 'Close Edith' : 'Ask Edith'}>
        <img className="edith-avatar edith-avatar-launcher" src="/edith.svg" alt="" />
